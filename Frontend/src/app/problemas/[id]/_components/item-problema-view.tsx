    ...
    <Card className="mx-auto w-full max-w-lg">
      ...
      <CardContent>
        <section className="space-y-4">
          ...
          <div>
            <h3 className="font-semibold">Asignarse incidente</h3>
            <ul className="space-y-4">
            {problema.estado == "detectado" || problema.estado == "analizandose" ? (
              <p>Permitir asignarmelo </p>
            ) : (<p>No se puede asignar</p>)
            }
            </ul>
          </div>
          </div>
